...
import { e as r } from './chunk-ZTXRY76I.js';
import { d as m, g as p } from './chunk-XJJY6XHD.js';
import { $b as o, Yb as d, ab as g, ia as s, yb as n, zb as t } from './chunk-GV4MRAZ3.js';
var h = class a {
  _componentPageTitle = s(l);
  mainContentClass = !0;
  ngOnInit() {
  ...
  static ɵcmp = g({
    ...
    hostBindings: function (e, i) {
      e & 2 && d('main-content', i.mainContentClass);
    },
    decls: 10,
    vars: 0,
    consts: [
      ...
      [1, 'docs-header-headline'],
      [1, 'mat-h1'],
      [1, 'docs-header-start'],
      ['mat-raised-button', '', 'routerLink', '/categories', 1, 'docs-button'],
    ],
    template: function (e, i) {
      e & 1 &&
        (n(0, 'header', 0)(1, 'div', 1)(2, 'div', 2)(3, 'h1', 3),
        o(4, 'Angular Material AcontPlus Libs'),
        t(),
        n(5, 'h2'),
        o(6, 'AcontPlus Material Design extended components for Angular'),
        t()(),
        n(7, 'div', 4)(8, 'a', 5),
        o(9, 'Get started'),
        t()()()());
