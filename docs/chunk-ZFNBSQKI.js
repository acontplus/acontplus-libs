import { A as xt, c as W, d as vt } from './chunk-7JP3HI6F.js';
import { a as kt } from './chunk-XJJY6XHD.js';
import {
  Ab as v,
  Ca as st,
  Da as C,
...
function Vt(i, n) {
  if (
    ...
    let t = u();
    (x('mdc-checkbox--disabled', t.disabled),
      h(),
      b('checked', t.selected)('disabled', t.disabled));
  }
}
function Qt(i, n) {
  if (
    (i & 1 &&
      (m(0, 'div', 17), v(1, 'input', 18), m(2, 'div', 19), v(3, 'div', 20)(4, 'div', 21), p()()),
    i & 2)
  ) {
    let t = u();
    (x('mdc-radio--disabled', t.disabled), h(), b('checked', t.selected)('disabled', t.disabled));
  }
}
function Ht(i, n) {}
function Gt(i, n) {
  if ((i & 1 && (m(0, 'span', 4), f(1, Ht, 0, 0, 'ng-template', 6), p()), i & 2)) {
    u();
    let t = y(3);
    (h(), b('ngTemplateOutlet', t));
  }
}
function qt(i, n) {}
function Ut(i, n) {
  if ((i & 1 && (m(0, 'span', 5), f(1, qt, 0, 0, 'ng-template', 6), p()), i & 2)) {
    u();
    let t = y(5);
    (h(), b('ngTemplateOutlet', t));
  }
...
function Kt(i, n) {}
function Xt(i, n) {
  if ((i & 1 && f(0, Kt, 0, 0, 'ng-template', 6), i & 2)) {
    u();
    let t = y(1);
    b('ngTemplateOutlet', t);
  }
}
function Wt(i, n) {}
function Zt(i, n) {
  if ((i & 1 && (m(0, 'span', 9), f(1, Wt, 0, 0, 'ng-template', 6), p()), i & 2)) {
    u();
    let t = y(3);
    (h(), b('ngTemplateOutlet', t));
  }
...
function Yt(i, n) {}
function Jt(i, n) {
  if ((i & 1 && (m(0, 'span', 9), f(1, Yt, 0, 0, 'ng-template', 6), p()), i & 2)) {
    u();
    let t = y(5);
    (h(), b('ngTemplateOutlet', t));
  }
...
function $t(i, n) {}
function ti(i, n) {
  if ((i & 1 && f(0, $t, 0, 0, 'ng-template', 6), i & 2)) {
    u();
    let t = y(1);
    b('ngTemplateOutlet', t);
  }
}
var Mt = new E('ListOption'),
  It = (() => {
    class i {
      _elementRef = o(M);
      constructor() {}
    ...
    class i {
      ...
      static ɵdir = g({
        ...
        hostBindings: function (e, a) {
          e & 2 &&
            x('mdc-list-item__start', a._isAlignedAtStart())(
              'mdc-list-item__end',
              !a._isAlignedAtStart(),
            );
        },
  ...
  T = (() => {
    class i {
      ...
      set disabled(t) {
        this._disabled.set(_(t));
      }
      _disabled = F(!1);
      _defaultOptions = o(ci, { optional: !0 });
      static ɵfac = function (e) {
        return new (e || i)();
      };
      static ɵdir = g({
        ...
        hostVars: 1,
        hostBindings: function (e, a) {
          e & 2 && w('aria-disabled', a.disabled);
        },
  ...
  Z = (() => {
    class i {
      ...
      _icons;
      set lines(t) {
        ((this._explicitLines = rt(t, null)), this._updateItemLines(!1));
      }
      _explicitLines = null;
      get disableRipple() {
        return (
      ...
      constructor() {
        o(dt).load(ft);
        let t = o(ut, { optional: !0 });
        ((this.rippleConfig = t || {}),
          (this._hostElement = this._elementRef.nativeElement),
          (this._isButtonElement = this._hostElement.nodeName.toLowerCase() === 'button'),
          this._listBase && !this._listBase._isNonInteractive && this._initInteractiveListItem(),
      ...
      ngOnDestroy() {
        (this._subscriptions.unsubscribe(),
          this._rippleRenderer !== null && this._rippleRenderer._removeTriggerEvents());
      }
      _hasIconOrAvatar() {
      ...
      _monitorProjectedLinesAndTitle() {
        this._ngZone.runOutsideAngular(() => {
          this._subscriptions.add(
            tt(this._lines.changes, this._titles.changes).subscribe(() =>
      ...
      _updateItemLines(t) {
        ...
        t && this._checkDomForUnscopedTextContent();
        let e = this._explicitLines ?? this._inferLinesFromContent(),
          a = this._unscopedContent.nativeElement;
        if (
          (this._hostElement.classList.toggle('mat-mdc-list-item-single-line', e <= 1),
          this._hostElement.classList.toggle('mdc-list-item--with-one-line', e <= 1),
          this._hostElement.classList.toggle('mdc-list-item--with-two-lines', e === 2),
          this._hostElement.classList.toggle('mdc-list-item--with-three-lines', e === 3),
          this._hasUnscopedTextContent)
        ) {
          let c = this._titles.length === 0 && e === 1;
          (a.classList.toggle('mdc-list-item__primary-text', c),
            a.classList.toggle('mdc-list-item__secondary-text', !c));
        } else
          (a.classList.remove('mdc-list-item__primary-text'),
            a.classList.remove('mdc-list-item__secondary-text'));
      }
      _inferLinesFromContent() {
        let t = this._titles.length + this._lines.length;
        return (this._hasUnscopedTextContent && (t += 1), t);
      }
      _checkDomForUnscopedTextContent() {
        this._hasUnscopedTextContent = Array.from(this._unscopedContent.nativeElement.childNodes)
          .filter((t) => t.nodeType !== t.COMMENT_NODE)
      ...
      static ɵdir = g({
        type: i,
        contentQueries: function (e, a, c) {
          if ((e & 1 && z(c, ei, 4)(c, ai, 4), e & 2)) {
            let s;
            (r((s = d())) && (a._avatars = s), r((s = d())) && (a._icons = s));
          }
        },
        hostVars: 4,
        hostBindings: function (e, a) {
          e & 2 &&
            (w('aria-disabled', a.disabled)('disabled', (a._isButtonElement && a.disabled) || null),
            x('mdc-list-item--disabled', a.disabled));
        },
...
var Bi = (() => {
    class i extends Z {
      ...
      static ɵcmp = L({
        ...
        contentQueries: function (e, a, c) {
          if ((e & 1 && z(c, At, 5)(c, It, 5)(c, ii, 5), e & 2)) {
            let s;
            (r((s = d())) && (a._lines = s),
              r((s = d())) && (a._titles = s),
              r((s = d())) && (a._meta = s));
        ...
        viewQuery: function (e, a) {
          if ((e & 1 && U(Lt, 5)(Ft, 5), e & 2)) {
            let c;
            (r((c = d())) && (a._unscopedContent = c.first),
              r((c = d())) && (a._itemText = c.first));
          }
        },
        ...
        hostBindings: function (e, a) {
          e & 2 &&
            (w('aria-current', a._getAriaCurrent()),
            x('mdc-list-item--activated', a.activated)(
              'mdc-list-item--with-leading-avatar',
              a._avatars.length !== 0,
            )('mdc-list-item--with-leading-icon', a._icons.length !== 0)(
              'mdc-list-item--with-trailing-meta',
              a._meta.length !== 0,
            )('mat-mdc-list-item-both-leading-and-trailing', a._hasBothLeadingAndTrailing())(
          ...
          if (e & 1) {
            ...
            (D(Rt),
              ...
              O('cdkObserveContent', function () {
                return (V(c), Q(a._updateItemLines(!0)));
              }),
              l(6, 3),
              p()(),
              l(7, 4),
  ...
  Dt = new E('SelectionList'),
  si = (() => {
    class i extends Z {
      _selectionList = o(Dt);
      _changeDetectorRef = o(K);
      _lines;
      _titles;
      _unscopedContent;
      selectedChange = new H();
      togglePosition = 'after';
      get checkboxPosition() {
        return this.togglePosition;
      }
      set checkboxPosition(t) {
        this.togglePosition = t;
      }
      get color() {
      ...
      set value(t) {
        (this.selected && t !== this.value && this._inputsInitialized && (this.selected = !1),
          (this._value = t));
      }
      _value;
      get selected() {
      ...
      set selected(t) {
        ...
        e !== this._selected &&
          (this._setSelected(e),
          (e || this._selectionList.multiple) && this._selectionList._reportValueChange());
      }
      _selected = !1;
      _inputsInitialized = !1;
      ngOnInit() {
        let t = this._selectionList;
        t._value && t._value.some((a) => t.compareWith(this._value, a)) && this._setSelected(!0);
        let e = this._selected;
        (Promise.resolve().then(() => {
          (this._selected || e) && ((this.selected = !0), this._changeDetectorRef.markForCheck());
        }),
      ...
      getLabel() {
        return (
          (this._titles?.get(0)?._elementRef.nativeElement || this._unscopedContent?.nativeElement)
            ?.textContent || ''
        );
      }
      _hasCheckboxAt(t) {
        return this._selectionList.multiple && this._getTogglePosition() === t;
      }
      _hasRadioAt(t) {
        return (
          !this._selectionList.multiple &&
          this._getTogglePosition() === t &&
          !this._selectionList.hideSingleSelectionIndicator
        );
      }
      _hasIconsOrAvatarsAt(t) {
        return this._hasProjected('icons', t) || this._hasProjected('avatars', t);
      }
      _hasProjected(t, e) {
        return (
          this._getTogglePosition() !== e &&
          (t === 'avatars' ? this._avatars.length !== 0 : this._icons.length !== 0)
        );
      }
      _handleBlur() {
      ...
      _toggleOnInteraction() {
        this.disabled ||
          (this._selectionList.multiple
            ? ((this.selected = !this.selected), this._selectionList._emitChangeEvent([this]))
            : this.selected ||
              ((this.selected = !0), this._selectionList._emitChangeEvent([this])));
      }
      _setTabindex(t) {
        this._hostElement.setAttribute('tabindex', t + '');
      }
      _hasBothLeadingAndTrailing() {
        let t =
      ...
      static ɵcmp = L({
        ...
        contentQueries: function (e, a, c) {
          if ((e & 1 && z(c, At, 5)(c, It, 5), e & 2)) {
            let s;
            (r((s = d())) && (a._lines = s), r((s = d())) && (a._titles = s));
          }
        },
        viewQuery: function (e, a) {
          if ((e & 1 && U(Lt, 5), e & 2)) {
        ...
        hostBindings: function (e, a) {
          (e & 1 &&
            O('blur', function () {
              return a._handleBlur();
            })('click', function () {
              return a._toggleOnInteraction();
            }),
            e & 2 &&
              (w('aria-selected', a.selected),
              x(
                'mdc-list-item--selected',
                a.selected &&
                  !a._selectionList.multiple &&
                  a._selectionList.hideSingleSelectionIndicator,
              )('mdc-list-item--with-leading-avatar', a._hasProjected('avatars', 'before'))(
                'mdc-list-item--with-leading-icon',
                a._hasProjected('icons', 'before'),
              )('mdc-list-item--with-trailing-icon', a._hasProjected('icons', 'after'))(
                'mat-mdc-list-option-with-trailing-avatar',
                a._hasProjected('avatars', 'after'),
              )('mdc-list-item--with-leading-checkbox', a._hasCheckboxAt('before'))(
                'mdc-list-item--with-trailing-checkbox',
                a._hasCheckboxAt('after'),
              )('mdc-list-item--with-leading-radio', a._hasRadioAt('before'))(
                'mdc-list-item--with-trailing-radio',
                a._hasRadioAt('after'),
              )('mat-mdc-list-item-both-leading-and-trailing', a._hasBothLeadingAndTrailing())(
                'mat-accent',
                a.color !== 'primary' && a.color !== 'warn',
              )('mat-warn', a.color === 'warn')('_mat-animation-noopable', a._noopAnimations)));
        },
        inputs: {
        ...
        features: [
          P([
            { provide: Z, useExisting: i },
            { provide: Mt, useExisting: i },
          ]),
          k,
        ],
        ...
        template: function (e, a) {
          if (e & 1) {
            let c = q();
            (D(Bt),
              f(0, Nt, 1, 0, 'ng-template', null, 0, B)(2, Vt, 6, 4, 'ng-template', null, 1, B)(
                4,
                Qt,
                5,
                4,
              ...
              I(6, Gt, 2, 1, 'span', 4)(7, Ut, 2, 1, 'span', 5),
              I(8, Xt, 1, 1, null, 6),
              m(9, 'span', 7),
              l(10),
              l(11, 1),
              ...
              l(14, 2),
              p()(),
              I(15, Zt, 2, 1, 'span', 9)(16, Jt, 2, 1, 'span', 9),
              I(17, ti, 1, 1, null, 6),
              l(18, 3),
              v(19, 'div', 10));
          }
          e & 2 &&
            (h(6),
            A(a._hasCheckboxAt('before') ? 6 : a._hasRadioAt('before') ? 7 : -1),
            h(2),
            A(a._hasIconsOrAvatarsAt('before') ? 8 : -1),
            h(7),
            A(a._hasCheckboxAt('after') ? 15 : a._hasRadioAt('after') ? 16 : -1),
            h(2),
            A(a._hasIconsOrAvatarsAt('after') ? 17 : -1));
        },
        dependencies: [nt, X],
        styles: [
...
var ji = (() => {
    class i extends T {
      ...
      static ɵcmp = L({
        ...
        exportAs: ['matNavList'],
        features: [P([{ provide: T, useExisting: i }]), k],
  ...
  oi = { provide: vt, useExisting: it(() => ni), multi: !0 },
  Y = class {
    source;
    options;
    constructor(n, t) {
      ((this.source = n), (this.options = t));
    }
  },
  ni = (() => {
    class i extends T {
      ...
      set multiple(t) {
        ...
        e !== this._multiple &&
          ((this._multiple = e),
          (this.selectedOptions = new W(this._multiple, this.selectedOptions.selected)));
      }
      _multiple = !0;
      ...
      set hideSingleSelectionIndicator(t) {
        this._hideSingleSelectionIndicator = _(t);
      }
      _hideSingleSelectionIndicator = this._defaultOptions?.hideSingleSelectionIndicator ?? !1;
      selectedOptions = new W(this._multiple);
      _value;
      _onTouched = () => {};
      _changeDetectorRef = o(K);
      constructor() {
        (super(), (this._isNonInteractive = !1));
      }
      ngAfterViewInit() {
        ((this._initialized = !0),
      ...
      ngOnChanges(t) {
        let e = t.disabled,
          a = t.disableRipple,
          c = t.hideSingleSelectionIndicator;
        ((a && !a.firstChange) || (e && !e.firstChange) || (c && !c.firstChange)) &&
          this._markOptionsForCheck();
      }
      ngOnDestroy() {
        (this._keyManager?.destroy(),
          this._listenerCleanups?.forEach((t) => t()),
      ...
      _reportValueChange() {
        if (this.options && !this._isDestroyed) {
          let t = this._getSelectedOptionValues();
          (this._onChange(t), (this._value = t));
        }
      }
      _emitChangeEvent(t) {
        this.selectionChange.emit(new Y(this, t));
      }
      writeValue(t) {
        ((this._value = t), this.options && this._setOptionsFromValues(t || []));
      }
      setDisabledState(t) {
        ((this.disabled = t), this._changeDetectorRef.markForCheck(), this._markOptionsForCheck());
      }
      get disabled() {
        return this._selectionListDisabled();
      }
      set disabled(t) {
        (this._selectionListDisabled.set(_(t)),
          this._selectionListDisabled() && this._keyManager?.setActiveItem(-1));
      }
      _selectionListDisabled = F(!1);
      registerOnChange(t) {
        this._onChange = t;
      }
      registerOnTouched(t) {
      ...
      _watchForSelectionChange() {
        this.selectedOptions.changed.pipe(N(this._destroyed)).subscribe((t) => {
          for (let e of t.added) e.selected = !0;
          for (let e of t.removed) e.selected = !1;
          this._containsFocus() || this._resetActiveOption();
        });
      }
      _setOptionsFromValues(t) {
        (this.options.forEach((e) => e._setSelected(!1)),
          t.forEach((e) => {
            let a = this.options.find((c) => (c.selected ? !1 : this.compareWith(c.value, e)));
            a && a._setSelected(!0);
          }));
      }
      ...
      _markOptionsForCheck() {
        this.options && this.options.forEach((t) => t._markForCheck());
      }
      _setAllOptionsSelected(t, e) {
        let a = [];
        return (
          this.options.forEach((c) => {
            (!e || !c.disabled) && c._setSelected(t) && a.push(c);
          }),
          a.length && this._reportValueChange(),
          a
        );
      }
      get options() {
      ...
      _handleKeydown(t) {
        let e = this._keyManager.activeItem;
        if (
          ...
          (t.preventDefault(), e._toggleOnInteraction());
        else if (
          t.keyCode === 65 &&
          this.multiple &&
          !this._keyManager.isTyping() &&
          pt(t, 'ctrlKey', 'metaKey')
        ) {
          let a = this.options.some((c) => !c.disabled && !c.selected);
          (t.preventDefault(), this._emitChangeEvent(this._setAllOptionsSelected(a, !0)));
        } else this._keyManager.onKeydown(t);
      }
      _handleFocusout = () => {
        setTimeout(() => {
          this._containsFocus() || this._resetActiveOption();
      ...
      _handleFocusin = (t) => {
        ...
        let e = this._items
          .toArray()
          .findIndex((a) => a._elementRef.nativeElement.contains(t.target));
        e > -1 ? this._setActiveOption(e) : this._resetActiveOption();
      };
      _setupRovingTabindex() {
        ((this._keyManager = new _t(this._items)
          .withHomeAndEnd()
          .withTypeAhead()
          .withWrap()
          .skipPredicate(() => this.disabled)),
          this._resetActiveOption(),
          this._keyManager.change.subscribe((t) => this._setActiveOption(t)),
          this._items.changes.pipe(N(this._destroyed)).subscribe(() => {
            let t = this._keyManager.activeItem;
            (!t || this._items.toArray().indexOf(t) === -1) && this._resetActiveOption();
          }));
      }
      _setActiveOption(t) {
        (this._items.forEach((e, a) => e._setTabindex(a === t ? 0 : -1)),
      ...
      _resetActiveOption() {
        ...
        let t = this._items.find((e) => e.selected && !e.disabled) || this._items.first;
        this._setActiveOption(t ? this._items.toArray().indexOf(t) : -1);
      }
      _containsFocus() {
        let t = lt();
        return t && this._element.nativeElement.contains(t);
      }
      static ɵfac = function (e) {
        return new (e || i)();
      };
      static ɵcmp = L({
        ...
        hostBindings: function (e, a) {
          (e & 1 &&
            O('keydown', function (s) {
              return a._handleKeydown(s);
            }),
            e & 2 && w('aria-multiselectable', a.multiple));
        },
        inputs: {
          color: 'color',
        ...
        features: [P([oi, { provide: T, useExisting: i }, { provide: Dt, useExisting: i }]), k, st],
        ngContentSelectors: yt,
        decls: 1,
        vars: 0,
        template: function (e, a) {
  ...
  Ni = (() => {
    class i {
      ...
      static ɵmod = R({ type: i });
      static ɵinj = S({ imports: [ht, kt, xt, j, wt] });
    }
    return i;
  })();
export { Bi as a, si as b, ji as c, ni as d, Ni as e };
