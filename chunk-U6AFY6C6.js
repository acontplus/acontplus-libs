import { a as se, b as v } from './chunk-TEMGEHUK.js';
import './chunk-IS3KC4W2.js';
import { b as ie } from './chunk-ZTXRY76I.js';
import './chunk-4JMGPBNX.js';
import { a as O } from './chunk-2H7DIYLF.js';
import {
  A as Ce,
  B as be,
  C as xe,
...
import { a as le, b as de, c as I, e as R, j as F } from './chunk-U7VJQUDE.js';
import { c as ne, d as oe, g as re } from './chunk-XJJY6XHD.js';
import {
  $b as t,
  Ab as s,
  Eb as g,
...
var B = class a {
  columns = [
    ...
    { header: 'Date', field: 'date', type: 'date', typeParameter: { format: 'yyyy-MM-dd' } },
  ];
  list = De;
  trackByName(n, r) {
    return r.name;
  ...
  static ɵcmp = C({
    type: a,
    selectors: [['app-data-grid-basic-example']],
    decls: 1,
    vars: 3,
    consts: [[3, 'data', 'columns', 'trackBy']],
    template: function (r, o) {
      (r & 1 && s(0, 'acp-data-grid', 0),
        r & 2 && d('data', o.list)('columns', o.columns)('trackBy', o.trackByName));
    },
    dependencies: [N],
    encapsulation: 2,
  });
...
v.highlightAll();
var ve = `<acp-data-grid [data]="list" [columns]="columns" [trackBy]="trackByName"></acp-data-grid>
`,
  _e = `
...
`,
  Ee = '/* Estilos espec\xEDficos para el ejemplo de Data Grid b\xE1sico */',
  Te = `export const EXAMPLE_DATA: any[] = [
  {
    position: 1,
    name: 'Boron',
    tag: [{ color: 'red', value: [1, 2] }],
...
`,
  Ae = {
    ...
    component: B,
    files: [
      { file: 'app.html', content: v.highlightAuto(ve).value, filecontent: ve },
      { file: 'app.ts', content: v.highlightAuto(_e).value, filecontent: _e },
      { file: 'app.styles', content: v.highlightAuto(Ee).value, filecontent: Ee },
      { file: 'data.ts', content: v.highlightAuto(Te).value, filecontent: Te },
    ],
  };
var Pe = () => [5, 10, 25],
  Ge = (a, n) => ({ status: a, actions: n });
function ke(a, n) {
  if (a & 1) {
    let r = M();
    (i(0, 'button', 21),
...
function Ie(a, n) {
  if (
    ...
    let r = n.$implicit;
    (l(2),
      x('Details for ', r.name),
      l(4),
      x(' ', r.description),
      l(4),
      x(' ', r.category),
      l(4),
      x(' ', K(15, 4, r.createdAt, 'medium')));
  }
}
function Re(a, n) {
  if ((a & 1 && (i(0, 'mat-chip'), t(1), A(2, 'titlecase'), e()), a & 2)) {
    let r = n.rowData;
    (Q('status-' + r.status), l(), x(' ', G(2, 3, r.status), ' '));
  }
}
function Fe(a, n) {
  if (a & 1) {
    ...
    (i(0, 'button', 23),
      b('click', function (c) {
        let m = y(r).rowData;
        return (T().onEdit(m), w(c.stopPropagation()));
      }),
      i(1, 'mat-icon'),
      t(2, 'edit'),
      e()(),
      ...
      b('click', function (c) {
        let m = y(r).rowData;
        return (T().onDelete(m), w(c.stopPropagation()));
      }),
      i(4, 'mat-icon'),
      t(5, 'delete'),
      e()());
...
function Oe(a, n) {
  if ((a & 1 && (i(0, 'p', 18), t(1), e()), a & 2)) {
    let r = T();
    (l(), x('Last cell clicked: ', r.lastCellClick()));
  }
}
var V = class a {
  selectedRows = D([]);
  ...
  sortableColumns = [
    { field: 'id', header: 'ID', type: 'number', sortable: !0 },
    { field: 'name', header: 'Name', sortable: !0 },
    { field: 'price', header: 'Price', type: 'currency', sortable: !0 },
    { field: 'createdAt', header: 'Created', type: 'date', sortable: !0 },
  ];
  styledColumns = [
  ...
  rowClassFormatter = {
    'row-completed': (n) => n.status === 'completed',
    'row-pending': (n) => n.status === 'pending',
    'row-failed': (n) => n.status === 'failed',
  };
  rowSelectionFormatter = {
    disabled: (n) => n.disableSelection === !0,
    hideCheckbox: (n) => n.status === 'failed',
  };
  constructor() {
    this.loadServerData(0, 5);
  }
  generateData(n) {
    let r = ['pending', 'processing', 'completed', 'failed'],
      o = ['Electronics', 'Clothing', 'Food', 'Books', 'Sports'];
    return Array.from({ length: n }, (c, m) => ({
      id: m + 1,
      name: `Product ${m + 1}`,
      description: `Description for product ${m + 1}`,
      price: Math.round(Math.random() * 1e3 * 100) / 100,
      quantity: Math.floor(Math.random() * 100),
      category: o[m % o.length],
      status: r[m % r.length],
  ...
  loadServerData(n, r) {
    (this.isLoading.set(!0),
      setTimeout(() => {
        let o = n * r;
        (this.serverData.set(
          Array.from({ length: r }, (c, m) => ({
            id: o + m + 1,
            name: `Server Item ${o + m + 1}`,
            description: `Server description ${o + m + 1}`,
  ...
  onRowSelected(n) {
    this.selectedRows.set(n);
  }
  clearSelection() {
    this.selectedRows.set([]);
  }
  onSortChange(n) {
    console.info('Sort changed:', n);
  }
  onPageChange(n) {
    console.info('Page changed:', n);
  }
  onServerPageChange(n) {
    this.loadServerData(n.pageIndex, n.pageSize);
  }
  onEdit(n) {
    console.info('Edit:', n);
  }
  onDelete(n) {
    console.info('Delete:', n);
  }
  onCellClick(n) {
    this.lastCellClick.set(`${n.column.field}: ${n.row[n.column.field]}`);
  }
  onFocusedRowChange(n) {
    (this.focusedIndex.set(n.index), this.highlightedIndex.set(n.index));
  }
...
/>`;
  ...
  static ɵcmp = C({
    type: a,
    selectors: [['app-data-grid-examples']],
    decls: 84,
    vars: 75,
    consts: [
      ['expansionTpl', ''],
      ...
      [3, 'page', 'data', 'columns', 'showPaginator', 'pageSize', 'pageSizeOptions'],
      [
        3,
        'page',
        'data',
      ...
      [3, 'data', 'columns', 'rowClassFormatter', 'rowStriped'],
      [3, 'data', 'columns', 'expandable', 'expansionTemplate', 'closeOthersOnExpand'],
      [3, 'data', 'columns', 'cellTemplate'],
      ['toolbarTitle', 'Products', 3, 'data', 'columns', 'showToolbar', 'showColumnMenuButton'],
      [3, 'cellClick', 'data', 'columns', 'cellSelectable'],
      [1, 'cell-info'],
      [1, 'instruction'],
      [3, 'focusedRowChange', 'data', 'columns', 'keyboardNavigation', 'highlightedRowIndex'],
      ['mat-button', '', 3, 'click'],
      [1, 'expansion-content'],
    ...
    template: function (r, o) {
      if (r & 1) {
        let c = M();
        (i(0, 'div', 3)(1, 'app-doc-heading'),
          t(2, 'Data Grid Examples'),
          e(),
          i(3, 'h2'),
          t(4, 'Basic Usage'),
          e(),
          i(5, 'mat-card', 4)(6, 'mat-card-content'),
          s(7, 'acp-data-grid', 5),
          e()(),
          s(8, 'app-code-example', 6),
          i(9, 'h2'),
          t(10, 'Row Selection'),
          e(),
          i(11, 'mat-card', 4)(12, 'mat-card-content')(13, 'div', 7)(14, 'span'),
          t(15),
          e(),
          _(16, ke, 2, 0, 'button', 8),
          e(),
          i(17, 'acp-data-grid', 9),
          b('rowSelectedChange', function (u) {
            return (y(c), w(o.onRowSelected(u)));
          }),
          e()()(),
          s(18, 'app-code-example', 6),
          i(19, 'h2'),
          t(20, 'Sorting'),
          e(),
          i(21, 'mat-card', 4)(22, 'mat-card-content')(23, 'acp-data-grid', 10),
          b('sortChange', function (u) {
            return (y(c), w(o.onSortChange(u)));
          }),
          e()()(),
          s(24, 'app-code-example', 6),
          i(25, 'h2'),
          t(26, 'Pagination'),
          e(),
          i(27, 'mat-card', 4)(28, 'mat-card-content')(29, 'acp-data-grid', 11),
          b('page', function (u) {
            return (y(c), w(o.onPageChange(u)));
          }),
          e()()(),
          s(30, 'app-code-example', 6),
          i(31, 'h2'),
          t(32, 'Server-side Pagination'),
          e(),
          i(33, 'mat-card', 4)(34, 'mat-card-content')(35, 'acp-data-grid', 12),
          b('page', function (u) {
            return (y(c), w(o.onServerPageChange(u)));
          }),
          e()()(),
          s(36, 'app-code-example', 6),
          i(37, 'h2'),
          t(38, 'Row Styling'),
          e(),
          i(39, 'mat-card', 4)(40, 'mat-card-content'),
          s(41, 'acp-data-grid', 13),
          e()(),
          s(42, 'app-code-example', 6),
          i(43, 'h2'),
          t(44, 'Expandable Rows'),
          e(),
          i(45, 'mat-card', 4)(46, 'mat-card-content'),
          s(47, 'acp-data-grid', 14),
          p(48, Ie, 16, 7, 'ng-template', null, 0, k),
          e()(),
          s(50, 'app-code-example', 6),
          i(51, 'h2'),
          t(52, 'Custom Cell Templates'),
          e(),
          i(53, 'mat-card', 4)(54, 'mat-card-content'),
          s(55, 'acp-data-grid', 15),
          p(56, Re, 3, 5, 'ng-template', null, 1, k)(58, Fe, 6, 0, 'ng-template', null, 2, k),
          e()(),
          s(60, 'app-code-example', 6),
          i(61, 'h2'),
          t(62, 'Toolbar with Column Menu'),
          e(),
          i(63, 'mat-card', 4)(64, 'mat-card-content'),
          s(65, 'acp-data-grid', 16),
          e()(),
          s(66, 'app-code-example', 6),
          i(67, 'h2'),
          t(68, 'Cell Selection'),
          e(),
          i(69, 'mat-card', 4)(70, 'mat-card-content')(71, 'acp-data-grid', 17),
          b('cellClick', function (u) {
            return (y(c), w(o.onCellClick(u)));
          }),
          e(),
          _(72, Oe, 2, 1, 'p', 18),
          e()(),
          s(73, 'app-code-example', 6),
          i(74, 'h2'),
          t(75, 'Keyboard Navigation'),
          e(),
          i(76, 'mat-card', 4)(77, 'mat-card-content')(78, 'p', 19),
          t(79, 'Use arrow keys to navigate, Enter to select'),
          e(),
          i(80, 'acp-data-grid', 20),
          b('focusedRowChange', function (u) {
            return (y(c), w(o.onFocusedRowChange(u)));
          }),
          e(),
          i(81, 'p', 18),
          t(82),
          e()()(),
          s(83, 'app-code-example', 6),
          e());
      }
      if (r & 2) {
        let c = P(49),
          ...
          u = P(59);
        (l(7),
          d('data', o.basicData)('columns', o.basicColumns),
          l(),
          d('code', o.basicCode)('language', 'typescript'),
          l(7),
          x('Selected: ', o.selectedRows().length, ' items'),
          l(),
          E(o.selectedRows().length > 0 ? 16 : -1),
          l(),
          d('data', o.demoData)('columns', o.selectionColumns)('rowSelectable', !0)(
            'multiSelectable',
            !0,
          )('rowSelectionFormatter', o.rowSelectionFormatter),
          l(),
          d('code', o.selectionCode)('language', 'typescript'),
          l(5),
          d('data', o.demoData)('columns', o.sortableColumns)('sortOnFront', !0),
          l(),
          d('code', o.sortingCode)('language', 'typescript'),
          l(5),
          d('data', o.paginatedData)('columns', o.basicColumns)('showPaginator', !0)('pageSize', 5)(
            'pageSizeOptions',
            Y(71, Pe),
          ),
          l(),
          d('code', o.paginationCode)('language', 'typescript'),
          l(5),
          d('data', o.serverData())('columns', o.basicColumns)('showPaginator', !0)(
            'pageOnFront',
            !1,
          )('length', o.totalItems)('pageSize', 5)('loading', o.isLoading()),
          l(),
          d('code', o.serverPaginationCode)('language', 'typescript'),
          l(5),
          d('data', o.styledData)('columns', o.styledColumns)(
            'rowClassFormatter',
            o.rowClassFormatter,
          )('rowStriped', !0),
          l(),
          d('code', o.rowStylingCode)('language', 'typescript'),
          l(5),
          d('data', o.demoData.slice(0, 5))('columns', o.basicColumns)('expandable', !0)(
            'expansionTemplate',
            c,
          )('closeOthersOnExpand', !0),
          l(3),
          d('code', o.expandableCode)('language', 'typescript'),
          l(5),
          d('data', o.demoData.slice(0, 5))('columns', o.templateColumns)(
            'cellTemplate',
            Z(72, Ge, m, u),
          ),
          l(5),
          d('code', o.cellTemplateCode)('language', 'typescript'),
          l(5),
          d('data', o.demoData.slice(0, 5))('columns', o.basicColumns)('showToolbar', !0)(
            'showColumnMenuButton',
            !0,
          ),
          l(),
          d('code', o.toolbarCode)('language', 'html'),
          l(5),
          d('data', o.demoData.slice(0, 5))('columns', o.basicColumns)('cellSelectable', !0),
          l(),
          E(o.lastCellClick() ? 72 : -1),
          l(),
          d('code', o.cellSelectionCode)('language', 'typescript'),
          l(7),
          d('data', o.demoData.slice(0, 5))('columns', o.basicColumns)('keyboardNavigation', !0)(
            'highlightedRowIndex',
            o.highlightedIndex(),
          ),
          l(2),
          x('Focused row: ', o.focusedIndex()),
          l(),
          d('code', o.keyboardNavCode)('language', 'html'));
      }
    },
    dependencies: [ae, F, I, R, re, oe, ne, ce, me, de, le, N, S, O, ee, te],
    styles: [
...
function Ne(a, n) {
  a & 1 && (i(0, 'th', 10), t(1, 'Name'), e());
}
function Be(a, n) {
  if ((a & 1 && (i(0, 'td', 11)(1, 'code'), t(2), e()()), a & 2)) {
    let r = n.$implicit;
    (l(2), h(r.name));
  }
}
function ze(a, n) {
  a & 1 && (i(0, 'th', 10), t(1, 'Type'), e());
}
function He(a, n) {
  if ((a & 1 && (i(0, 'td', 11)(1, 'code'), t(2), e()()), a & 2)) {
    let r = n.$implicit;
...
function Ve(a, n) {
  a & 1 && (i(0, 'th', 10), t(1, 'Description'), e());
}
function $e(a, n) {
  if ((a & 1 && (i(0, 'td', 11), t(1), e()), a & 2)) {
    let r = n.$implicit;
    (l(), h(r.description));
  }
}
function Le(a, n) {
  a & 1 && (i(0, 'th', 10), t(1, 'Default'), e());
}
function We(a, n) {
  if ((a & 1 && (i(0, 'td', 11)(1, 'code'), t(2), e()()), a & 2)) {
    let r = n.$implicit;
  ...
  static ɵcmp = C({
    ...
    template: function (r, o) {
      (r & 1 &&
        ...
        i(5, 'table', 1),
        g(6, 2),
        p(7, Ne, 2, 0, 'th', 3)(8, Be, 3, 1, 'td', 4),
        f(),
        g(9, 5),
        p(10, ze, 2, 0, 'th', 3)(11, He, 3, 1, 'td', 4),
        f(),
        g(12, 6),
        p(13, Ve, 2, 0, 'th', 3)(14, $e, 2, 1, 'td', 4),
        f(),
        g(15, 7),
        p(16, Le, 2, 0, 'th', 3)(17, We, 3, 1, 'td', 4),
        f(),
        p(18, je, 1, 0, 'tr', 8)(19, Ue, 1, 0, 'tr', 9),
        e(),
        i(20, 'h2'),
        t(21, 'Outputs'),
        e(),
        i(22, 'table', 1),
        g(23, 2),
        p(24, qe, 2, 0, 'th', 3)(25, Xe, 3, 1, 'td', 4),
        f(),
        g(26, 5),
        p(27, Qe, 2, 0, 'th', 3)(28, Ye, 3, 1, 'td', 4),
        f(),
        g(29, 6),
        p(30, Ze, 2, 0, 'th', 3)(31, Ke, 2, 1, 'td', 4),
        f(),
        g(32, 7),
        p(33, Je, 2, 0, 'th', 3)(34, et, 3, 1, 'td', 4),
        f(),
        p(35, tt, 1, 0, 'tr', 8)(36, at, 1, 0, 'tr', 9),
        e(),
        i(37, 'h2'),
        t(38, 'DataGridColumn Interface'),
        e(),
        i(39, 'table', 1),
        g(40, 2),
        p(41, it, 2, 0, 'th', 3)(42, nt, 3, 1, 'td', 4),
        f(),
        g(43, 5),
        p(44, ot, 2, 0, 'th', 3)(45, rt, 3, 1, 'td', 4),
        f(),
        g(46, 6),
        p(47, lt, 2, 0, 'th', 3)(48, dt, 2, 1, 'td', 4),
        f(),
        g(49, 7),
        p(50, st, 2, 0, 'th', 3)(51, mt, 3, 1, 'td', 4),
        f(),
        p(52, ct, 1, 0, 'tr', 8)(53, pt, 1, 0, 'tr', 9),
        e()()),
        r & 2 &&
          (l(5),
          d('dataSource', o.inputs),
          l(13),
          d('matHeaderRowDef', o.displayedColumns),
          l(),
          d('matRowDefColumns', o.displayedColumns),
          l(3),
          d('dataSource', o.outputs),
          l(13),
          d('matHeaderRowDef', o.displayedColumns),
          l(),
          d('matRowDefColumns', o.displayedColumns),
          l(3),
          d('dataSource', o.columnProperties),
          l(13),
          d('matHeaderRowDef', o.displayedColumns),
          l(),
          d('matRowDefColumns', o.displayedColumns)));
    },
    dependencies: [Se, pe, ge, we, fe, ue, Ce, he, ye, be, xe, S],
    styles: [
...
acp-data-grid {
  ...
  static ɵcmp = C({
    type: a,
    selectors: [['app-data-grid-styling']],
    decls: 101,
    vars: 14,
    consts: [
      [1, 'docs-component-viewer-content'],
    ...
    template: function (r, o) {
      (r & 1 &&
        (i(0, 'div', 0)(1, 'app-doc-heading'),
        t(2, 'Data Grid Styling'),
        e(),
        i(3, 'p', 1),
        t(
          4,
          ' Customize the Data Grid appearance using CSS variables, row formatters, and SCSS theming. The grid supports Material Design 3 tokens for consistent theming. ',
        ),
        e(),
        i(5, 'h2'),
        t(6, 'CSS Variables'),
        e(),
        i(7, 'mat-card', 2)(8, 'mat-card-content')(9, 'p'),
        t(10, 'Use Material Design 3 tokens for consistent theming:'),
        e(),
        i(11, 'ul', 3)(12, 'li')(13, 'code'),
        t(14, '--mat-sys-surface'),
        e(),
        t(15, ' - Table background'),
        e(),
        i(16, 'li')(17, 'code'),
        t(18, '--mat-sys-on-surface'),
        e(),
        t(19, ' - Text color'),
        e(),
        i(20, 'li')(21, 'code'),
        t(22, '--mat-sys-surface-container'),
        e(),
        t(23, ' - Header background'),
        e(),
        i(24, 'li')(25, 'code'),
        t(26, '--mat-sys-surface-container-highest'),
        e(),
        t(27, ' - Highlighted row'),
        e(),
        i(28, 'li')(29, 'code'),
        t(30, '--mat-sys-primary'),
        e(),
        t(31, ' - Selection color'),
        e(),
        i(32, 'li')(33, 'code'),
        t(34, '--mat-sys-outline-variant'),
        e(),
        t(35, ' - Border color'),
        e()()()(),
        i(36, 'h2'),
        t(37, 'Row Class Formatter'),
        e(),
        i(38, 'p', 4),
        t(39, ' Use '),
        i(40, 'code'),
        t(41, 'rowClassFormatter'),
        e(),
        t(42, ' to dynamically apply CSS classes to rows based on data. '),
        e(),
        s(43, 'app-code-example', 5),
        i(44, 'h2'),
        t(45, 'Row Selection Formatter'),
        e(),
        i(46, 'p', 4),
        t(47, ' Control row selection behavior with '),
        i(48, 'code'),
        t(49, 'rowSelectionFormatter'),
        e(),
        t(50, '. '),
        e(),
        s(51, 'app-code-example', 5),
        i(52, 'h2'),
        t(53, 'Custom Cell Styling'),
        e(),
        i(54, 'p', 4),
        t(55, ' Apply custom styles to cells using the column '),
        i(56, 'code'),
        t(57, 'class'),
        e(),
        t(58, ' property or cell templates. '),
        e(),
        s(59, 'app-code-example', 5),
        i(60, 'h2'),
        t(61, 'Size Variants'),
        e(),
        i(62, 'mat-card', 2)(63, 'mat-card-content')(64, 'p'),
        t(65, 'Control table density with the '),
        i(66, 'code'),
        t(67, 'size'),
        e(),
        t(68, ' input:'),
        e(),
        i(69, 'ul', 3)(70, 'li')(71, 'code'),
        t(72, 'small'),
        e(),
        t(73, ' - Compact rows (32px height)'),
        e(),
        i(74, 'li')(75, 'code'),
        t(76, 'medium'),
        e(),
        t(77, ' - Medium rows (40px height)'),
        e(),
        i(78, 'li')(79, 'code'),
        t(80, 'normal'),
        e(),
        t(81, ' - Default rows (48px height)'),
        e()()()(),
        s(82, 'app-code-example', 5),
        i(83, 'h2'),
        t(84, 'Striped Rows'),
        e(),
        i(85, 'p', 4),
        t(86, 'Enable alternating row colors for better readability.'),
        e(),
        s(87, 'app-code-example', 5),
        i(88, 'h2'),
        t(89, 'Highlighted Row'),
        e(),
        i(90, 'p', 4),
        t(91, ' Use '),
        i(92, 'code'),
        t(93, 'highlightedRowIndex'),
        e(),
        t(94, ' to highlight a specific row, useful for keyboard navigation. '),
        e(),
        s(95, 'app-code-example', 5),
        i(96, 'h2'),
        t(97, 'Global SCSS Customization'),
        e(),
        i(98, 'p', 4),
        t(99, 'Override default styles with SCSS variables.'),
        e(),
        s(100, 'app-code-example', 5),
        e()),
        r & 2 &&
          (l(43),
          d('code', o.rowClassFormatterCode)('language', 'typescript'),
          l(8),
          d('code', o.rowSelectionFormatterCode)('language', 'typescript'),
          l(8),
          d('code', o.cellStylingCode)('language', 'typescript'),
          l(23),
          d('code', o.sizeCode)('language', 'html'),
          l(5),
          d('code', o.stripedCode)('language', 'html'),
          l(8),
          d('code', o.highlightedCode)('language', 'html'),
          l(5),
          d('code', o.scssCustomizationCode)('language', 'styles')));
    },
    dependencies: [F, I, R, S, O],
    styles: [
      '.docs-component-viewer-content[_ngcontent-%COMP%]{padding:24px;max-width:1200px}h2[_ngcontent-%COMP%]{margin-top:32px;margin-bottom:16px}.docs-component-description[_ngcontent-%COMP%], .section-description[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface-variant);margin-bottom:16px;line-height:1.6}.docs-example-card[_ngcontent-%COMP%]{margin-bottom:16px}.features-list[_ngcontent-%COMP%]{margin:8px 0;padding-left:24px}.features-list[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]{margin-bottom:8px}.features-list[_ngcontent-%COMP%]   code[_ngcontent-%COMP%]{background:var(--mat-sys-surface-container);padding:2px 6px;border-radius:4px}',
    ],
  });
};
function ut(a, n) {
  if ((a & 1 && s(0, 'app-doc-heading', 0)(1, 'app-example-viewer', 1), a & 2)) {
    let r = n.$implicit;
    (d('text', r.title), l(), d('exampleData', r));
  }
}
function gt(a, n) {
  (a & 1 && q(0, ut, 2, 2, null, null, U), a & 2 && X(n.examples));
}
var W = class a {
    route = j(ie);
    examples = [];
    ...
    static ɵcmp = C({
      type: a,
      selectors: [['app-data-grid-overview']],
      decls: 7,
      vars: 3,
      consts: [
        [3, 'text'],
      ...
      template: function (r, o) {
        if (
          (r & 1 &&
            ...
            t(
              4,
              ` es un potente componente de tabla basado en Material. Admite selecci\xF3n de celdas, selecci\xF3n de filas, selecci\xF3n m\xFAltiple de filas, expansi\xF3n de filas, ocultamiento de columnas, movimiento de columnas y muchas otras funciones.
`,
            ),
            e(),
            _(5, gt, 2, 0),
          ...
          let c;
          (l(5), E((c = G(6, 1, o.route.data)) ? 5 : -1, c));
        }
      },
      dependencies: [S, se, J],
      encapsulation: 2,
  ...
  ra = [
    ...
    { path: 'overview', component: W, pathMatch: 'full', data: { examples: [Ae] } },
    { path: 'examples', component: V },
    { path: 'api', component: $ },
    { path: 'styling', component: L },
    { path: '**', redirectTo: 'overview' },
  ];
export { W as GridOverview, ra as routes };
